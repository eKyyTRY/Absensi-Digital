<div>
    <form wire:submit.prevent="saveEmployees" method="post" novalidate>
            ...
            <div class="w-100">
                ...
                <div class="mb-3">
                    <x-form-label id="password{{ $i }}"
                        label='Password Siswa {{ $i + 1 }} (default: "123" jika tidak diisi)' required="false" />
                ...
                <div class="mb-3">
                    <x-form-label id="position_id{{ $i }}" label='Jabatan / Posisi Siswa {{ $i + 1 }}' />
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <button class="btn btn-orange" type="button" wire:click="addEmployeeInput" wire:loading.attr="disabled"> <!-- Menggunakan btn-orange untuk warna oranye -->
                Tambah Input
            </button>
        </div>
    </form>
